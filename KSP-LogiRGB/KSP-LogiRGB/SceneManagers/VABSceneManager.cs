...
namespace KSP_LogiRGB.SceneManagers
{
    ...
    internal class VABSceneManager : SceneManager
    {
        ...
        {
            currentColorScheme.SetKeysToColor(new[] {KeyCode.Alpha1, KeyCode.Alpha2, KeyCode.Alpha3, KeyCode.Alpha4},
                Color.white);
        ...
        {
            currentColorScheme.SetKeysToColor(new[] {KeyCode.X, KeyCode.C}, Color.red);
